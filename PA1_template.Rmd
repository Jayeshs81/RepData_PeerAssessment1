...
Mean of Total Steps taken per day is **`r as.integer(mean(totalSteps, na.rm = TRUE))`**.  
Median of Total Steps taken per day **`r as.integer(median(totalSteps, na.rm = TRUE))`**.  
...
On average across all days in the dataset, the **`r names(which.max(intervalSteps))`**th 5-minute interval contains the maximum number of steps.

#### Imputing missing values
The total number of missing values in the dataset is **`r sum(!complete.cases(activity))`**  
...
Mean of Total Steps taken per day is **`r as.integer(mean(totalImpSteps, na.rm = TRUE))`**.  
Median of Total Steps taken per day is **`r as.integer(median(totalImpSteps, na.rm = TRUE))`**
